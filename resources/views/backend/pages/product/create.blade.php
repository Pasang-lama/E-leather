                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text"
                                       ...
                                       value="{{ old('slug') }}" name="slug" id="slug" autocomplete="off" />
                                    @error('slug')
                                    <span class="text-danger">
                                    {{ $errors->first('slug') }}
                                    </span>
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <select
                                       ...
                                       @include('backend/pages/product/recursive_create_child_category',
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="number"
                                       ...
                                       placeholder="Enter Weight Of Product" autocomplete="off" />
                                    @error('weight')
                                    <span class="text-danger">
                                    {{ $errors->first('weight') }}
                                    </span>
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="number"
                                       ...
                                       value="{{ old('regular_price') }}" placeholder="Price" autocomplete="off" />
                                    @error('regular_price')
                                    <span class="text-danger">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="number"
                                       ...
                                       min="0" value="0" max="100" name="discount_percent"
                                       id="discount_percent" placeholder="Enter Discount Percent" autocomplete="off">
                           ...
                           <div class="col-md-4 append-col">
                              <div class="card">
                                 <img class="card-img-top" src="{{ asset('images/default.png') }}"
                                    alt="Product Image" height="auto" width="200px" id="pic">
                                 <div class="card-body">
                                    <p class="card-text">
                           ...
                           <div class="col-md-12">
                              ...
                              <div class="form-group">
                                 ...
                                 <textarea
                                    ...
                                    value="{{ old('seo_description') }}" name="seo_description"
                                    rows="5"></textarea>
                              ...
                              <div class="form-group">
                                 ...
                                 <textarea name="seo_keyword" id="seo_keyword"
                                    class="form-control {{ $errors->has('seo_keyword') ? 'is-invalid' : '' }}">{!! old('seo_keyword') !!}</textarea>
                                 @error('seo_keyword')
                                 <span class="text-danger">
