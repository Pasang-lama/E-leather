                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control {{ $errors->has('product_name') ? 'is-invalid' : '' }}" name="product_name" id="product_name" placeholder="Enter Product Name" value="{{ $product->product_name }}" autocomplete="off" />
                                 @error('product_name')
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control {{ $errors->has('product_code') ? 'is-invalid' : '' }}" name="product_code" id="product_code" placeholder="Enter Product Code" value="{{ $product->product_code }}" autocomplete="off" />
                                 @error('product_code')
                                 <span class="text-danger">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="number" class="form-control {{ $errors->has('regular_price') ? 'is-invalid' : '' }}" name="regular_price" id="regular_price" placeholder="Price" value="{{ $product->regular_price }}" autocomplete="off" />
                                 @error('regular_price')
                                 <span class="text-danger">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="number" class="form-control {{ $errors->has('discount_percent') ? 'is-invalid' : '' }}" min="0" max="100" name="discount_percent" id="discount_percent" value="{{ $product->discount_percent }}" placeholder="Enter Discount Percent" autocomplete="off" />
                     ...
                     <div class="card-body">
                        <div class="row">
                           <div class="col-md-4 append-col">
                              <div class="card">
                                 <img class="card-img-top" src="{{ (( $product->product_image != '') && file_exists(public_path('images/'. $product->product_image))) ? asset('images/'. $product->product_image) :  asset('images/default.png')  }}" alt="Product Image" id="pic" height="auto" width="200px">
                                 <div class="card-body">
                                    <p class="card-text">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control  {{ $errors->has('seo_title') ? 'is-invalid' : '' }}" name="seo_title" value="{{ $product->seo_title }}" id="seo_title" placeholder="Enter SEO Title">
                                 @error('seo_title')
                                 <span class="text-danger">
                              ...
                              <div class="form-group">
                                 ...
                                 <textarea class="form-control {{ $errors->has('seo_description') ? 'is-invalid' : '' }}" name="seo_description" rows="5">{{ $product->seo_description }}</textarea>
                              ...
                              <div class="form-group">
                                 ...
                                 <textarea name="seo_keyword" id="seo_keyword" class="form-control {{ $errors->has('seo_keyword') ? 'is-invalid' : '' }}">{{ old('seo_keyword')?  old('seo_keyword')   : $product->seo_keyword }}</textarea>
                                 @error('seo_keyword')
                                 <span class="text-danger">
                              ...
                              <div class="form-group">
                                 <label>Schema</label>
                                 <textarea name="schema" id="schema" class="form-control {{ $errors->has('schema') ? 'is-invalid' : '' }}">{{old('schema') ? old('schema') : $product->schema}}</textarea>
                                 @error('schema')
                                 <span class="text-danger">
                                    {{ $errors->first('schema') }}
                                 </span>
                     ...
                     <div class="card-body">
                        <div class="form-group">
                           <div class="custom-control custom-switch">
                              <input type="checkbox" class="custom-control-input" id="statusSwitch" name="status" value="1" {{ old('status') ? 'checked' : '' }} @if ($product->status == 1) checked @endif>
                        ...
                        <div class="form-group">
                           <div class="custom-control custom-switch">
                              <input type="checkbox" class="custom-control-input" id="saleSwitch" name="sale" value="1" {{ old('sale') ? 'checked' : '' }} @if ($product->sale == 1) checked @endif>
